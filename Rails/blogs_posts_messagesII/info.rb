...
User.create(first_name: "Jessica", last_name: "Doe", email_address: "jessica@doe.com")
User.create(first_name: "Michael", last_name: "Smith", email_address: "michael@smith.com")
User.create(first_name: "Michelle", last_name: "Smith", email_address: "michelle@smith.com")
